...
// Verify Config variables are set
...
function handleApiAiAction(sender, action, responseText, contexts, parameters) {
	switch (action) {
		...
		let	buttons = [
	 {
		 ...
		 title:"Track my project progress"
	 },
	 {
		 type:"phone_number",
		 title:"Call us",
...
function greetUserText(userId) {
	...
	request({
		...
		if (!error && response.statusCode == 200) {
			...
			' and I help Dexter schedule his appointment. What can I help you with?');
			} else {
